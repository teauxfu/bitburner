...
export function BitverseRoot(props: IProps): React.ReactElement {
  ...
  return (
    ...
    <>
      ...
      <Typography sx={{lineHeight: '1em',whiteSpace: 'pre'}}> \| <BitNodePortal n={14} level={n(14)} flume={props.flume} destroyedBitNode={destroyed} />   |  |_/    |\|   \ <BitNodePortal n={13} level={n(13)} flume={props.flume} destroyedBitNode={destroyed} />    \__|    \_|  |   O |/ </Typography>
